...
public class CollectionFactory {
	...
	public static List<Employee> getEmployeeList(){
		...
		skills1.add(new Skill("HTML", 7));
		skills1.add(new Skill("CSS", 8));
		e1.setSkills(skills1);
		
		List<Skill> skills2=new ArrayList<>();
		skills2.add(new Skill("Oracle DB", 9));
		skills2.add(new Skill("JavaScript", 8));
		e2.setSkills(skills2);
		
		List<Skill> skills3=new ArrayList<>();
		skills3.add(new Skill("JavaScript", 7));
		skills3.add(new Skill("CSS", 5));
		e3.setSkills(skills3);
		
		List<Skill> skills4=new ArrayList<>();
		skills4.add(new Skill("Java SE", 6));
		skills4.add(new Skill("HTML", 4));
		e4.setSkills(skills4);
		
		List<Skill> skills5=new ArrayList<>();
		skills5.add(new Skill("Node JS", 8));
		skills5.add(new Skill("React JS", 4));
		e5.setSkills(skills4);
